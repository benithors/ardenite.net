...
const ArdeniteSlider = (props: IProps) => {
    ...
    return (
            <div className="relative navigation-wrapper pt-16 h-full w-screen overflow-clip">
                <div ref={sliderRef} className="keen-slider flex flex-row  h-full ">

                    {[...Array(15)].map((x, i) =>
                        <div key={i} className="keen-slider__slide flex flex-col text-turquoise  min-w-full h-fit md:min-w-[50%]">
                            <div>
                                Ardenite Shirt
                            </div>
                            <div className={"lightBox bg-pink h-fit w-full"}>
                                <Image
                                    src={imageOne}
                                    alt="Ardenite"
                                    layout='responsive'
...
function ArdeniteRightArrow(props: {
    ...
    return (
        <svg
            ...
            className={`arrow ${
                props.left ? "arrow--left" : "arrow--right"
            } ${disabeld}`} width="157" height="202" viewBox="0 0 157 202" fill="none" xmlns="http://www.w3.org/2000/svg">
